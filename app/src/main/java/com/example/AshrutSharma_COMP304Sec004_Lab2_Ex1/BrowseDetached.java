...
public class BrowseDetached extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_detached);

        //Checkboxes
        CheckBox checkBox1 = (CheckBox) findViewById(R.id.chkDetach1);
        ...
        CheckBox checkBox2 = (CheckBox) findViewById(R.id.chkDetach2);
        ...
        CheckBox checkBox3 = (CheckBox) findViewById(R.id.chkDetach3);
        ...
        checkOutButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BrowseDetached.this, CheckOut.class);
